...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://paperly.online"),
  keywords: [
    "Nigeria News",
...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "Organization",
      "@id": "https://paperly.online/#organization",
      "name": "PAPERLY.",
      "url": "https://paperly.online",
      "logo": {
        "@type": "ImageObject",
        "url": "https://paperly.online/icon.png"
      },
    ...
    {
      "@type": "WebSite",
      "@id": "https://paperly.online/#website",
      "url": "https://paperly.online",
      "name": "PAPERLY.",
      ...
      "potentialAction": {
        ...
        "target": {
          "@type": "EntryPoint",
          "urlTemplate": "https://paperly.online/?q={search_term_string}"
        },
