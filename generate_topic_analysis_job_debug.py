...
class GenerateTopicAnalysisJob:
    ...
    async def execute(self, topic_id: int):
        ...
        print("╚" + "="*78 + "╝")
        print(f"Mode: {'🚀 OPTIMIZED (1 API call)' if self.use_optimized else '⚠️  LEGACY (4 API calls)'}")
        print()
        ...
        try:
            ...
            query = select(RawArticle).join(TopicArticle).where(TopicArticle.topic_id == topic_id)
            ...
            if not contents:
                print(f"❌ No content found in articles")
                return
            ...
            print(f"✅ Summary generated ({len(analysis_data.get('summary', ''))} chars)")
            ...
            if category_config:
                ...
                if sentiment_items:
                    ...
                    print(f"✅ Overall sentiment: {overall_sentiment} (score: {sentiment_score:.2f})")
                else:
                    print("⚠️  No sentiment items found - using neutral")
                print()
            ...
            print("\n" + "╔" + "="*78 + "╗")
            print("║ ✅ ANALYSIS COMPLETED SUCCESSFULLY".ljust(79) + "║")
            print("╚" + "="*78 + "╝\n")

        except Exception as e:
            print("\n" + "╔" + "="*78 + "╗")
            print(f"║ ❌ ERROR IN ANALYSIS".ljust(79) + "║")
            print("╚" + "="*78 + "╝")
            print(f"Error: {e}")
            print()
        ...
        sources_data = [
            {
                ...
                "headline": a.title,
                "type": a.source.source_type if a.source else "unknown"
            }
    ...
    async def _execute_legacy_analysis(
        ...
        # ... (keeping it simple for now since the focus is on optimized path)
